local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/NameLessHub/NameLessSieuMup/main/Source.Lua"))()
local Window = redzlib:MakeWindow({
  Title = "NameLess Hub : Blox Fruits",
  SubTitle = "by NameLess",
  SaveFolder = "NameLess🌈 Hub | Blox Fruits.lua"
})
...
Discord:AddDiscordInvite({
  Name = "NameLess🌈 Hub | Community",
  Description = "Join our discord community to receive information about the next update",
  Logo = "https://cdn.discordapp.com/attachments/1285957374602907658/1313141515945640016/Screenshot_20241202_205326_Discord.jpg?ex=674f0dd6&is=674dbc56&hm=8309aef482cf685cafcd8442d696cd8c26b529dfefe65067f1187668d99e02e9&",
  Invite = "https://discord.gg/KhJunK9c97"
})
...
RaceV4:AddToggle("RACEV4", {
  Title = "Auto Kill After Trial [ENABLE WHEN MATCH STARTED]",
  Default = true,
  Callback = function(Value)
    getgenv().AutoKillAfterTrial = Value
    AutoKillAfterTrial()
  end
})

local function AutoKillAfterTrial()
  local SavePos = Vector3.new()
  repeat task.wait()until Player.Character and Player.Character.PrimaryPart
  SavePos = Player.Character.PrimaryPart.Position
  
  local function GetNearest()
    local Distance, Nearest = 600
    local function Verify(_,Enemie)
      local EnemieH = Enemie:FindFirstChild("Humanoid")
      ...
      if EnemieH and EnemieH.Health > 0 then
        ...
        if EnemiePP and PlayerPP and (PlayerPP.Position).Magnitude <= Distance then
          Distance = (PlayerPP.Position).Magnitude
          Nearest = Enemie
        end
      end
    end
  ...
  while getgenv().AutoKillAfterTrial do task.wait()
    if getgenv().AutoKillAfterTrial then
    else
      local Enemie = GetNearest()
